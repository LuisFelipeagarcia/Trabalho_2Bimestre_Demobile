<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ped_editar.aspx.cs" Inherits="DeMobile.ped_editar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="margin-top: 15px">
        <div class="col-md-12 text-right">
            <asp:Label ID="lblIdP" runat="server" CssClass="text text-danger" Visible="false"></asp:Label>
        </div>
    </div>
    <div class="row" style="margin-top: 15px">
        <div class="col-md-12 text-right">
            <asp:Label ID="lblEstoque" runat="server" CssClass="text text-danger" Visible="false"></asp:Label>
        </div>
    </div>
</asp:Content>
